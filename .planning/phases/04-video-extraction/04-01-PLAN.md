<!-- SUPERSEDED: This plan described client-side extraction (native Expo module + Cobalt from app).
     It was implemented (commits 026fb7e-0c8f3ee) then reverted (1140ef5) in favor of a server-side
